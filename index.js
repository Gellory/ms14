...
client.on('ready', () => {
    var x = client.channels.get("558282218058022915");
    if (x) x.join();
});
...
client.on('ready', () => {
    ...
    client.user.setUsername("Na")
    client.user.setActivity("14play | MUSIC",{type: 'WATCHING'});
...
`)
      ...
      message.channel.send(' ** CHECK DM || شيك على الخاص ** ').then(message =>{
...
client.on('message', async message => {
    ...
    var frole = message.guild.member(message.author).roles.find(r => r.name === 'Programmer');
  ...
  if (message.content.startsWith(prefix + 'admin')) {
    ...
    .setTitle(' ** FAISAL || اوامر البوت  ')
    .setThumbnail(message.guild.iconURL)
    .addField(`** ${prefix}N **', ' ** Set USERNAME || اكتب الامر و بعدها اكتب النص المراد كتابته بمكان اسم البوت  ** `)
    .addField(`** ${prefix}G **', ' ** Set GAME || اكتب الامر و بعدها اكتب النص المراد كتابته اسفل اسم البوت ** `)
    .addField(`** ${prefix}W **', ' ** Set WATCHING || اكتب الامر و بعدها اكتب النص المراد كتابته اسفل اسم البوت ** `)
    .addField(`** ${prefix}L **', ' ** Set LISTENING || اكتب الامر و بعدها اكتب النص المراد كتابته اسفل اسم البوت ** `)
    .addField(`** ${prefix}S **', ' ** Set STREAMING || اكتب الامر و بعدها اكتب النص المراد كتابته اسفل اسم البوت ** `)
